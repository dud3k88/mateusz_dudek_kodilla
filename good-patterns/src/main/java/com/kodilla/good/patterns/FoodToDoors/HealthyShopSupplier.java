...
public class HealthyShopSupplier implements SupplierService {
    ...
    public HealthyShopSupplier(String supplierName, String supplierEmail, int supplierPhoneNumber) {
