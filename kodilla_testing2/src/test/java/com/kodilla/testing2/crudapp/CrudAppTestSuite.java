...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://dud3k88.github.io/";
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("mateusz.dudek88@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Plokijuh12");
    ...
    @Test
    public void shouldCreatedTrelloCard() throws InterruptedException {
